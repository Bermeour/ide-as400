...
/**
 * Clase: GlobalConfigure.java
 * Descripción: Implementación singleton de la fábrica de configuración global del emulador que gestiona el registro de propiedades, la carga y guardado de sesiones, macros y mapas de teclas en el directorio de usuario.
 */
