/**
 * Clase: SessionPopup.java
 * Descripción: Menú contextual de la sesión 5250 que presenta al usuario opciones como copiar, pegar, imprimir, transferir archivos, enviar correo y gestionar la conexión, delegando las acciones en el SessionPanel correspondiente.
 */
package com.ide.as400;

import static com.ide.as400.keyboard.KeyMnemonic.ATTN;
...
import static com.ide.as400.keyboard.KeyMnemonic.DUP_FIELD;
import static com.ide.as400.keyboard.KeyMnemonic.ERASE_EOF;
import static com.ide.as400.keyboard.KeyMnemonic.E_MAIL;
import static com.ide.as400.keyboard.KeyMnemonic.FIELD_MINUS;
import static com.ide.as400.keyboard.KeyMnemonic.FIELD_PLUS;
import static com.ide.as400.keyboard.KeyMnemonic.FILE_TRANSFER;
import static com.ide.as400.keyboard.KeyMnemonic.HELP;
import static com.ide.as400.keyboard.KeyMnemonic.NEW_LINE;
import static com.ide.as400.keyboard.KeyMnemonic.OPEN_NEW;
import static com.ide.as400.keyboard.KeyMnemonic.PASTE;
import static com.ide.as400.keyboard.KeyMnemonic.PRINT;
import static com.ide.as400.keyboard.KeyMnemonic.PRINT_SCREEN;
import static com.ide.as400.keyboard.KeyMnemonic.QUICK_MAIL;
import static com.ide.as400.keyboard.KeyMnemonic.RESET;
import static com.ide.as400.keyboard.KeyMnemonic.SPOOL_FILE;
import static com.ide.as400.keyboard.KeyMnemonic.SYSREQ;
...
import com.ide.as400.tools.LoadMacroMenu;
import com.ide.as400.tools.Macronizer;
import com.ide.as400.tools.SendScreenImageToFile;
import com.ide.as400.tools.SendScreenToFile;
...
public class SessionPopup {
  ...
  private void doMeSpool() {
    ...
    try {
      com.ide.as400.spoolfile.SpoolExporter spooler =
          new com.ide.as400.spoolfile.SpoolExporter(vt, sessiongui);
