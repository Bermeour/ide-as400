package com.ide.as400.sql;

/**
 * Clase: AS400Xtfr.java
 * Descripción: Clase que gestiona la transferencia de datos desde el AS/400 hacia el PC mediante
 * conexión SQL JDBC, ejecutando consultas y exportando los resultados a través de filtros de salida configurables.
 */
...
import com.ide.as400.event.FTPStatusEvent;
import com.ide.as400.event.FTPStatusListener;
import com.ide.as400.framework.tn5250.tnvt;
import com.ide.as400.tools.filters.FileFieldDef;
import com.ide.as400.tools.filters.OutputFilterInterface;
