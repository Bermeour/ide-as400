/**
 * Clase: RubberBand.java
 * Descripción: Clase abstracta que implementa la selección visual de áreas rectangulares mediante arrastre del ratón sobre el canvas de la sesión, gestionando el dibujado y borrado del rectángulo de selección con modo XOR.
 */
