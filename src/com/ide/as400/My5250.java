/**
 * Clase: My5250.java
 * Descripción: Clase principal y punto de entrada de la aplicación emuladora 5250 que orquesta la inicialización, apertura y cierre de sesiones, la gestión de múltiples ventanas y la comunicación entre instancias del emulador mediante el BootStrapper.
 */
...
import com.ide.as400.connectdialog.ConnectDialog;
import com.ide.as400.event.BootEvent;
import com.ide.as400.event.BootListener;
import com.ide.as400.event.EmulatorActionEvent;
import com.ide.as400.event.EmulatorActionListener;
import com.ide.as400.event.SessionChangeEvent;
import com.ide.as400.event.SessionListener;
import com.ide.as400.framework.Tn5250jController;
import com.ide.as400.framework.common.SessionManager;
import com.ide.as400.framework.common.Sessions;
import com.ide.as400.gui.TN5250jSplashScreen;
...
//		startFrameType();
	 ...
	 */
	 private void initScripting() {
		 ...
		 try {
			 Class.forName("com.ide.as400.scripting.JPythonInterpreterDriver");
		 }
