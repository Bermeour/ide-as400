...
/**
 * Clase: ErrorResetAttributesPanel.java
 * Descripción: Panel de configuración del comportamiento ante errores de la sesión 5250,
 * que permite indicar si se requiere reseteo de error explícito y si el retroceso genera error.
 */
