...
/**
 * Clase: SignoffAttributesPanel.java
 * Descripción: Panel de configuración de la confirmación de cierre de sesión (sign-off)
 * que permite activar el diálogo de confirmación y definir la región de pantalla donde se detecta el evento.
 */
