...
/**
 * Clase: KeypadAttributesPanel.java
 * Descripción: Panel de configuración del teclado virtual (keypad) de la sesión 5250, que permite
 * habilitar el keypad, ajustar el tamaño de fuente y configurar los botones visibles y su orden.
 */
...
import static com.ide.as400.SessionConfig.KEYPAD_FONT_SIZE_DEFAULT_VALUE;
import static com.ide.as400.SessionConfig.YES;
