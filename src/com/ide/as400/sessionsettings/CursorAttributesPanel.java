...
/**
 * Clase: CursorAttributesPanel.java
 * Descripción: Panel de configuración del cursor de la sesión 5250 que permite ajustar
 * el tamaño, estilo de cruceta, parpadeo y desplazamiento inferior del cursor.
 */
