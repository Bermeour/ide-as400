...
/**
 * Clase: SessionSettings.java
 * Descripción: Diálogo principal de configuración de sesión 5250 que organiza todos los paneles
 * de atributos en un árbol de navegación y permite aplicar, cancelar o guardar los cambios de configuración.
 */
