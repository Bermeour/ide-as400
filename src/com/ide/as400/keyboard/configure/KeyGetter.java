/**
 * Clase: KeyGetter.java
 * Descripción: Componente visual que captura y procesa eventos de teclado para permitir al usuario seleccionar una tecla o combinación de teclas que se asignará a una función del emulador.
 */
