/**
 * Clase: KeyStroker.java
 * Descripción: Envoltura interna de un evento de teclado que almacena el código de tecla y el estado de las teclas modificadoras (Shift, Control, Alt, AltGr) y la ubicación, utilizada como clave en el mapa de teclas del emulador.
 */
