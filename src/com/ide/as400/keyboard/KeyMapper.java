/**
 * Clase: KeyMapper.java
 * Descripción: Gestiona el mapa de teclas del emulador, encargándose de cargar, guardar y consultar las asociaciones entre KeyStroker y nemónicos de función, y de notificar a los listeners cuando el mapa cambia.
 */
