...
/**
 * Clase: SpoolExporter.java
 * Descripción: Ventana principal del explorador de archivos de spool AS/400 que muestra la lista
 * de archivos de spool en una tabla con opciones de filtrado, visualización, exportación y gestión de colas.
 */
