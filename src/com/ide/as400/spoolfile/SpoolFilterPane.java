...
/**
 * Clase: SpoolFilterPane.java
 * Descripción: Panel de filtros con pestañas para el explorador de spool que agrupa los filtros
 * por usuario, cola de salida, nombre de spool y datos de usuario, con soporte para reseteo individual o total.
 */
