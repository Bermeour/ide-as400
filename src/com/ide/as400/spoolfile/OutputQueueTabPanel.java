...
/**
 * Clase: OutputQueueTabPanel.java
 * Descripción: Panel de filtro por cola de salida (output queue) en el explorador de spool,
 * que permite seleccionar todos los archivos de spool o filtrar por cola y biblioteca específicas.
 */
