/**
 * Clase: HexCharMapDialog.java
 * Descripción: Diálogo que muestra el mapa de caracteres de una página de códigos, listando todos los valores
 * hexadecimales EBCDIC y sus caracteres Unicode equivalentes para que el usuario seleccione uno.
 */
