/**
 * Clase: Wizard.java
 * Descripción: Contenedor de tipo asistente que gestiona la navegación entre páginas WizardPage mediante
 * acciones de siguiente, anterior, finalizar, cancelar y ayuda, notificando a los WizardListener registrados.
 */
