/**
 * Clase: SystemRequestDialog.java
 * Descripción: Diálogo modal que solicita al usuario ingresar un nombre de trabajo alterno para enviar una
 * solicitud de sistema (SysReq), retornando el texto ingresado o null si se cancela.
 */
