...
import com.ide.as400.framework.tn5250.Rect;
import com.ide.as400.framework.tn5250.Screen5250;
import com.ide.as400.framework.tn5250.tnvt;
import com.ide.as400.gui.ConfirmTabCloseDialog;
import com.ide.as400.keyboard.KeyboardHandler;
import com.ide.as400.keyboard.KeyMnemonicSerializer;
import com.ide.as400.mailtools.SendEMailDialog;
import com.ide.as400.sessionsettings.SessionSettings;
...
import static com.ide.as400.SessionConfig.*;
...
public class SessionPanel extends JPanel implements RubberBandCanvasIF, SessionConfigListener, SessionListener {
	...
	public void actionSpool() {
		...
		try {
			com.ide.as400.spoolfile.SpoolExporter spooler =
				new com.ide.as400.spoolfile.SpoolExporter(session.getVT(), this);
	 ...
	 * @see com.ide.as400.Session5250#getSessionName()
	 */
