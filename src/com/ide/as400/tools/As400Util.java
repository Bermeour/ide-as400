/**
 * Clase: As400Util.java
 * Descripción: Clase de utilidades con métodos estáticos para la conversión de tipos de datos
 * propios del AS/400, como la conversión de campos decimales empaquetados (packed) a enteros.
 */
