/**
 * Clase: OpenOfficeOutputFilter.java
 * Descripción: Filtro de salida que genera archivos en formato OpenOffice Calc (SXC) empaquetados
 * como ZIP, con contenido XML que incluye estilos numéricos y filas de datos del AS/400.
 */
