/**
 * Clase: FileFieldDef.java
 * Descripción: Representa la definición de un campo de archivo AS/400 (FFD), con su tipo, longitud,
 * posición y precisión, proporcionando métodos para interpretar y convertir los datos binarios EBCDIC.
 */
