/**
 * Clase: XTFRFileFilter.java
 * Descripción: Filtro de archivos para diálogos de selección que acepta archivos según sus
 * extensiones registradas y gestiona la instanciación del filtro de salida asociado a cada formato.
 */
