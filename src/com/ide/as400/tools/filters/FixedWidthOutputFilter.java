/**
 * Clase: FixedWidthOutputFilter.java
 * Descripción: Filtro de salida que escribe los registros del AS/400 en formato de ancho fijo,
 * alineando cada campo a su longitud original con relleno de espacios o signos numéricos.
 */
