/**
 * Clase: DelimitedOutputFilter.java
 * Descripción: Filtro de salida que escribe los registros del AS/400 en formato delimitado (CSV u
 * otro separador configurable), con soporte para calificadores de texto en campos alfanuméricos.
 */
