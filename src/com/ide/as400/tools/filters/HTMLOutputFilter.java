/**
 * Clase: HTMLOutputFilter.java
 * Descripción: Filtro de salida que genera un archivo HTML con los datos del AS/400 formateados
 * en una tabla, incluyendo cabeceras con los nombres de campo y filas por cada registro.
 */
