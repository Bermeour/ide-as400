/**
 * Clase: ExcelOutputFilter.java
 * Descripción: Filtro de salida que genera archivos en formato binario Excel BIFF2, escribiendo
 * etiquetas y valores numéricos con formato de precisión decimal para cada campo seleccionado.
 */
