/**
 * Clase: GUIGraphicsUtils.java
 * Descripción: Clase de utilidades gráficas que provee métodos estáticos para dibujar bordes 3D,
 * ventanas, barras de scroll, gestionar fuentes y cargar iconos e imágenes de la aplicación.
 */
