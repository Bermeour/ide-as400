/**
 * Clase: Macronizer.java
 * Descripción: Gestiona el almacenamiento, recuperación y ejecución de macros de teclado y scripts
 * de sesión, permitiendo registrar secuencias de teclas o invocar archivos Python sobre la sesión activa.
 */
