/**
 * Clase: LangTool.java
 * Descripción: Herramienta de internacionalización que carga y provee acceso al paquete de
 * recursos de mensajes de la aplicación según la configuración regional activa.
 */
