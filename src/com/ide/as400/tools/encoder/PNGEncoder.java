/**
 * Clase: PNGEncoder.java
 * Descripción: Codificador que convierte una imagen Java en formato PNG escribiendo los bloques
 * IHDR, PLTE, IDAT e IEND con compresión DEFLATE directamente en el stream de salida.
 */
