/**
 * Clase: AbstractImageEncoder.java
 * Descripción: Clase base abstracta para codificadores de imágenes que captura la imagen de un
 * componente Swing y delega la escritura al stream en las subclases concretas.
 */
