/**
 * Clase: WizardListener.java
 * Descripción: Interfaz de escucha para asistentes (wizards) que define métodos de notificación para navegación entre páginas, finalización y cancelación del proceso.
 */
