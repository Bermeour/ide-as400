/**
 * Clase: ToolboxCodePageFactory.java
 * Descripción: Fábrica singleton que provee conversores de página de código usando la librería JT400 Toolbox de IBM mediante reflexión, soportando un amplio rango de CCSIDs adicionales.
 */
