/**
 * Clase: SendEMail.java
 * Descripción: Encapsula la lógica de envío de correo electrónico vía SMTP, permitiendo adjuntar
 * texto o archivos y configurando destinatarios, asunto y cuerpo del mensaje.
 */
