/**
 * Clase: SMTPConfig.java
 * Descripción: Diálogo de configuración de parámetros SMTP (servidor, puerto, remitente y nombre)
 * que permite guardar y cargar la configuración de correo electrónico saliente.
 */
