...
import com.ide.as400.gui.SystemRequestDialog;
import com.ide.as400.interfaces.ScanListener;
import com.ide.as400.interfaces.SessionInterface;

/**
 * Clase: Session5250.java
 * Descripción: Modelo de sesión de terminal 5250 que encapsula la conexión con el servidor AS/400, gestionando el ciclo de vida de la conexión, la configuración de la sesión, la pantalla virtual y la notificación de cambios de estado a los oyentes registrados.
 */
public class Session5250 implements SessionInterface {
	...
	/* (non-Javadoc)
	 * @see com.ide.as400.interfaces.SessionInterface#displaySystemRequest()
	 */
	@Override
