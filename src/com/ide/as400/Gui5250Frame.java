...
import com.ide.as400.event.SessionJumpListener;
import com.ide.as400.event.SessionListener;
import com.ide.as400.event.TabClosedListener;
import com.ide.as400.gui.ButtonTabComponent;
import com.ide.as400.interfaces.ConfigureFactory;
import com.ide.as400.interfaces.GUIViewInterface;
...
/**
 * Clase: Gui5250Frame.java
 * Descripción: Ventana principal del emulador que extiende JFrame y gestiona múltiples sesiones 5250 en pestañas, controlando la apertura, cierre y navegación entre sesiones así como la actualización del título de la ventana.
 */
...
SessionJumpListener {
	...
	public void stateChanged(ChangeEvent e) {
	 ...
	 /* (non-Javadoc)
	  * @see com.ide.as400.interfaces.GUIViewInterface#addSessionView(java.lang.String, com.ide.as400.SessionGUI)
	  */
	 @Override
	public void addSessionView(final String tabText, final SessionPanel sesspanel) {
	 ...
	 /* (non-Javadoc)
	  * @see com.ide.as400.event.TabClosedListener#onTabClosed(int)
	  */
	 @Override
	public void onTabClosed(int tabToBeClosed) {
	 ...
	 /* (non-Javadoc)
	  * @see com.ide.as400.interfaces.GUIViewInterface#removeSessionView(com.ide.as400.SessionGUI)
	  */
	 @Override
	public void removeSessionView(SessionPanel targetSession) {
	 ...
	 /* (non-Javadoc)
	  * @see com.ide.as400.interfaces.GUIViewInterface#getSessionViewCount()
	  */
	 @Override
	public int getSessionViewCount() {
	 ...
	 /* (non-Javadoc)
	  * @see com.ide.as400.interfaces.GUIViewInterface#getSessionAt(int)
	  */
	 @Override
	public SessionPanel getSessionAt( int index) {
	 ...
	 /* (non-Javadoc)
	  * @see com.ide.as400.interfaces.GUIViewInterface#onSessionChanged(com.ide.as400.event.SessionChangeEvent)
	  */
	 @Override
	public void onSessionChanged(SessionChangeEvent changeEvent) {
	 ...
	 /* (non-Javadoc)
	  * @see com.ide.as400.interfaces.GUIViewInterface#containsSession(com.ide.as400.SessionGUI)
	  */
	 @Override
