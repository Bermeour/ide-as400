/**
 * Clase: ScreenField.java
 * Descripción: Representa un campo de entrada individual en la pantalla 5250, almacenando
 * su posición, longitud, atributos de formato (FFW/FCW) y estado de modificación para
 * controlar la validación y transmisión de datos al host.
 */
