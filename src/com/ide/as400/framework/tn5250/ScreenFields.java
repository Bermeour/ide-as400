/**
 * Clase: ScreenFields.java
 * Descripción: Contenedor de la tabla de campos de formato (FFT) de la pantalla 5250 que
 * gestiona la colección de objetos ScreenField, controla el campo activo, la navegación
 * entre campos y la serialización de datos modificados para su envío al host.
 */
