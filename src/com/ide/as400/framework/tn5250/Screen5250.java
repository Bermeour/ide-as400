/**
 * Clase: Screen5250.java
 * Descripción: Modelo lógico de la pantalla de terminal 5250 que gestiona el estado de la
 * pantalla, el movimiento del cursor, la validación e introducción de datos en campos de
 * entrada, y el envío de teclas AID al servidor AS/400.
 */
			...
			if (g >= BUTTON_LEFT && g <= BUTTON_LAST) {
				...
				if (aidFlag) {
					...
					case BUTTON_RIGHT_EB:
						...
						com.ide.as400.tools.system.OperatingSystem.displayURL(eb
								.toString());
