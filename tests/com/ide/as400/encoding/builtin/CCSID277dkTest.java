/**
 * Clase: CCSID277dkTest.java
 * Descripción: Prueba la correctitud de la conversión byte EBCDIC↔Unicode para la variante danesa
 * de la página de código CCSID 277 (277-dk), comparando la implementación clásica con CCSID277.
 */
