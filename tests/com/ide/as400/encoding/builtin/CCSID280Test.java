/**
 * Clase: CCSID280Test.java
 * Descripción: Prueba la correctitud de la conversión Unicode↔EBCDIC para la página de código CCSID 280
 * (EBCDIC italiano), comparando la implementación clásica con la nueva implementación CCSID280.
 */
