/**
 * Clase: CCSID37Test.java
 * Descripción: Prueba la correctitud de la conversión Unicode↔EBCDIC para la página de código CCSID 37
 * (EBCDIC inglés de EE. UU.), comparando la implementación clásica con la nueva implementación CCSID37.
 */
