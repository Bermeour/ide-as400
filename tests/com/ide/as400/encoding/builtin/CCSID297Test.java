/**
 * Clase: CCSID297Test.java
 * Descripción: Prueba la correctitud de la conversión Unicode↔EBCDIC para la página de código CCSID 297
 * (EBCDIC francés), comparando la implementación clásica con la nueva implementación CCSID297.
 */
