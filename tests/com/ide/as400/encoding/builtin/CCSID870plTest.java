/**
 * Clase: CCSID870plTest.java
 * Descripción: Prueba la correctitud de la conversión byte EBCDIC↔Unicode para la variante polaca
 * de la página de código CCSID 870 (870-pl), comparando la implementación clásica con CCSID870.
 */
