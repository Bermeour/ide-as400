/**
 * Clase: CCSID284Test.java
 * Descripción: Prueba la correctitud de la conversión Unicode↔EBCDIC para la página de código CCSID 284
 * (EBCDIC español/latinoamericano), comparando la implementación clásica con la nueva implementación CCSID284.
 */
